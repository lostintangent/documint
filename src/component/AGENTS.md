...
- **Platform gestures become semantic editor policy at the input edge.** Component keybindings map the host platform to shortcut families and word-boundary styles before calling the editor. Lower layers receive semantic commands and boundary policy, never browser platform names.
