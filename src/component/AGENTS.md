...
- **The host owns render cadence.** `useRenderScheduler` chooses the cheapest valid paint mode, and `useViewport` owns the cached `EditorLayoutHandle` those paint paths consume.
