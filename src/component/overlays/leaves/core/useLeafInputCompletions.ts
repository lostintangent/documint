...
export function useLeafInputCompletions({
  ...
  const [anchor, setAnchor] = useState<LeafResolution | null>(null);
  ...
  // uses the same document-absolute LeafAnchor as document completions, so it
